!(function (t) {
  ...
  if (
    (VLTJS.window.on("load scroll", function () {
      ...
      n.each(function () {
        ...
        n.offset().top <= e + 90 && n.offset().top + n.outerHeight() > e + 90
          ? i.parent("li").addClass("current-menu-item")
          : i.parent("li").removeClass("sfHover current-menu-item");
      });
    }),
    ...
    t("ul.sf-menu li.current-menu-item")
      .parents("li")
      .addClass("current-menu-item"),
    void 0 !== t.fn.stickySidebar &&
    ...
    void 0 !== t.fn.jarallax && t(".jarallax").jarallax({ speed: 0.8 }),
  ...
  "function" == typeof FastClick && FastClick.attach(document.body),
    ...
    void 0 !== t.fn.fancybox &&
      ((t.fancybox.defaults.btnTpl = {
        close:
          '<button data-fancybox-close class="fancybox-button fancybox-button--close"><i class="icon-cross"></i></button>',
        arrowLeft:
          '<a data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" href="javascript:;"><i class="icon-arrow-left"></i></a>',
        arrowRight:
          '<a data-fancybox-next class="fancybox-button fancybox-button--arrow_right" href="javascript:;"><i class="icon-arrow-right"></i></a>',
        smallBtn:
          '<button type="button" data-fancybox-close class="fancybox-button fancybox-close-small"><i class="icon-cross"></i></button>',
      }),
      ...
      init: function () {
        function e(t) {
          var e = t.closest(n),
            i = e.find("ul.sf-menu"),
            s = i.find(
              "li.menu-item-has-children.open > ul.sub-menu:not(.closed)"
            ),
            a = "";
          s.length && (a = s.innerHeight()), i.css({ height: a, minHeight: a });
        }
        function i(t, e) {
          ...
          gsap.set(i, { x: t ? "15%" : "-15%", opacity: 0, display: "block" }),
            gsap
              .timeline({
                defaults: { ease: VLTJS.submenuEffectStyle1.config.easing },
              })
              .to(i, 0.2, { x: "0%", opacity: 1, stagger: { amount: 0.2 } })
              .to(
                n,
                0.2,
                {
      ...
      (VLTJS.submenuEffectStyle2 = {
        ...
        init: function () {
          ...
          function i(t, e) {
            ...
            gsap.set(i, { opacity: 0, display: "block" }),
              gsap
                .timeline({
                  defaults: { ease: VLTJS.submenuEffectStyle2.config.easing },
                })
                .to(n, 0.2, {
                  opacity: 0,
                  stagger: { amount: 0.2 },
                ...
                .to(i, 0.2, { opacity: 1, stagger: { amount: 0.2 } });
          }
    ...
    (VLTJS.menuCreative = {
      init: function () {
        ...
        n.on("click", function (t) {
          t.preventDefault(),
            e
              ? (n.removeClass("vlt-menu-burger--opened"),
                VLTJS.menuCreative.close_menu(i))
              : (n.addClass("vlt-menu-burger--opened"),
                VLTJS.menuCreative.open_menu(i, s));
        }),
          VLTJS.document.keyup(function (t) {
            27 === t.keyCode &&
              e &&
              (t.preventDefault(), VLTJS.menuCreative.close_menu(i));
          });
      },
      ...
      init: function () {
        ...
        n.on("click", function (t) {
          ...
          VLTJS.document.keyup(function (t) {
            27 === t.keyCode &&
              e &&
              (t.preventDefault(), VLTJS.menuFullscreen.close_menu(i));
          });
      },
      open_menu: function (t, i) {
        (e = !0),
          ...
          n.on("click", function (t) {
            t.preventDefault(),
              e
                ...
                : VLTJS.menuMobile.open_menu(i, n);
          }),
            VLTJS.document.keyup(function (t) {
              27 === t.keyCode &&
                (t.preventDefault(), VLTJS.menuMobile.close_menu(i, n));
            });
        },
        open_menu: function (t, i) {
          t.slideDown(),
        ...
        n.on("click", function (t) {
          t.preventDefault(),
            e
              ...
              : VLTJS.menuOffcanvas.open_menu(n, i, s, a);
        }),
          VLTJS.document.keyup(function (t) {
            27 === t.keyCode &&
              e &&
              (t.preventDefault(), VLTJS.menuOffcanvas.close_menu(n, i, a));
          }),
          a.on("click", function () {
        ...
        n.on("click", function (t) {
          t.preventDefault(),
            e
              ...
              : VLTJS.menuSlide.open_menu(n, i, s, a);
        }),
          VLTJS.document.keyup(function (t) {
            27 === t.keyCode &&
              e &&
              (t.preventDefault(), VLTJS.menuSlide.close_menu(n, i, a));
          }),
          a.on("click", function () {
        ...
        ((VLTJS.cursor = {
          init: function () {
            var e = t(".vlt-cursor"),
              ...
              a = 0.25;
            e.length &&
              (gsap.set(i, { xPercent: -50, yPercent: -50 }),
      ...
      init: function () {
        t(".vlt-devide-element").each(function () {
          var e = t(this),
            i = e.outerHeight() / 2;
          e.find(">div").css("margin-top", -i),
            e.hasClass("reset-mobile") &&
              VLTJS.window.outerWidth() <= 768 &&
              e.find(">div").css("margin-top", "");
        });
      },
    }),
    ...
    (VLTJS.columnSpaceToContainer = {
      init: function () {
        ...
        t(".vlt-column-space-to-container").each(function () {
          ...
          i.hasClass("to-left")
            ? i.css({ "padding-left": r })
            : i.css({ "padding-right": o / 2 });
        });
      },
    }),
          ...
          init: function () {
            ...
            e.length &&
              ...
              (VLTJS.window.on("load scroll", function () {
                ...
                i = 0.75 * (Math.max(0, t(this).scrollTop() + s - (a - n)) - n);
              }),
              gsap.ticker.add(function () {
                gsap.set(e, { translateY: i, translateZ: 0 });
              }));
          },
        }),
  ...
  (function (t) {
    ...
    function e() {
      t("[data-marquee]").each(function () {
        var e = t(this),
          i = e.data("marquee") || 0.5,
          n = e.find("[data-marquee-text]").first(),
          s = n.outerWidth(),
          a = n.outerHeight(),
          r = (s / a) * i + "s";
        "undefined" != typeof gsap &&
          gsap.set(e.find("[data-marquee-text]"), { animationDuration: r });
      });
    }
    function i() {
          ...
          i.length &&
            e
              .on("change", function (t, e) {
                ...
                i.css(
                  "transform",
                  "translateY(" + s + "px) translateX(" + n + "px)"
                );
              })
      ...
      t(".vlt-hover-reveal").remove(),
        t("[data-tooltip-image]").each(function (e) {
          function i(t) {
            ...
            gsap.set(d, {
              top: e.y - 0.5 * f - i.top + "px",
              left: e.x - 0.25 * p - i.left + "px",
            });
          }
          function n(t) {
            i(t), r();
          ...
          function r() {
            gsap.killTweensOf(u),
              ...
              gsap
                .timeline({
                  onStart: function () {
                    gsap.set(d, { opacity: 1 }), gsap.set(l, { zIndex: 1e3 });
                  },
                })
                .fromTo(u, 1, { x: "-100%" }, { x: "0%", ease: Quint.easeOut })
                .fromTo(
                  h,
                  1,
                  { x: "100%" },
                  { x: "0%", ease: Quint.easeOut },
                  "-=1"
                );
          }
          function o() {
            gsap.killTweensOf(u),
              ...
              gsap
                .timeline({
                  onStart: function () {
                    gsap.set(l, { zIndex: 999 });
                  },
                  onComplete: function () {
                    gsap.set(l, { zIndex: "" }), gsap.set(d, { opacity: 0 });
                  },
                })
                .to(u, 0.5, { x: "100%", ease: Quint.easeOut })
                .to(h, 0.5, { x: "-100%", ease: Quint.easeOut }, "-=0.5");
          }
          var l = t(this),
          ...
          VLTJS.body.append(
            '<div class="vlt-hover-reveal"><div class="vlt-hover-reveal__inner"><div class="vlt-hover-reveal__img" style="background-image: url(' +
              l.data("tooltip-image") +
              ');"></div></div></div>'
          ),
            c &&
              VLTJS.body
                .find(".vlt-hover-reveal")
                .css({ width: c[0] + "px", height: c[1] + "px" });
      ...
      (VLTJS.initPluginIsotope = {
        init: function () {
          "undefined" != typeof Isotope &&
            t(".vlt-isotope-grid").each(function () {
              function e(t, e, i) {
                VLTJS.window.width() >= 992
                  ? (t.css({
                      "margin-top": -i[0] / 2 + "px",
              ...
              c.imagesLoaded().progress(function () {
                ...
                l.length &&
                  l.on("click", "[data-filter]", function (e) {
                    e.preventDefault();
                    var i = t(this),
                      n = i.data("filter");
      ...
      init: function () {
        ...
        n.on("click", function (t) {
          ...
          VLTJS.document.keyup(function (t) {
            27 === t.keyCode &&
              e &&
              (t.preventDefault(), VLTJS.searchPopup.close_search(i, a));
          });
      },
  ...
  (function (t) {
    ...
    if ("undefined" != typeof gsap) {
      var e = t(".vlt-site-preloader"),
        i = e.data("animate-to");
      gsap.to(e.find("#vlt-site-preloader-path"), 1, { attr: { d: i } }),
        VLTJS.document.imagesLoaded(function () {
          setTimeout(function () {
        ...
        e.length
          ? e.on(VLTJS.transitionEnd, function () {
    ...
    (VLTJS.stickyNavbar = {
      init: function () {
        ...
        VLTJS.throttleScroll(function (t, e) {
          ...
          "down" === t && e > 450
            ? n()
            : ("up" !== t && "end" !== t && "start" !== t) || i(),
            s.hasClass("vlt-navbar--transparent") &&
              s.hasClass("vlt-navbar--sticky") &&
              (e > a
                ? s.addClass("vlt-navbar--solid")
                : s.removeClass("vlt-navbar--solid"));
        });
      },
    }),
      ...
      init: function () {
        ...
        t(".vlt-stretch-block").each(function () {
          ...
          i.hasClass("to-left") && i.find(">*").css("margin-left", -n),
            i.hasClass("to-right") &&
              i.find(">*").css("margin-right", n + s - e),
            i.hasClass("reset-mobile") &&
              VLTJS.window.outerWidth() <= 768 &&
              i.find(">*").css({ "margin-left": "", "margin-right": "" });
        });
      },
    }),
        ...
        if (e.length) {
          ...
          n.on("init slideChange", function () {
            var s = t(i),
              ...
              o = (a + 1) / r;
            "vertical" == s.data("direction")
              ? (s.find(".current").text(VLTJS.addLedingZero(a + 1)),
                s.find(".total").text(VLTJS.addLedingZero(r)))
              : (s.find(".current").text(a + 1), s.find(".total").text(r)),
              s
                .find(".bar > span")
                .css({ "--scaleX": o, "--speed": n.params.speed + "ms" });
          }),
            n.init();
        }
      },
    ...
    (VLTJS.contentSlider = {
      init: function () {
        "undefined" != typeof Swiper &&
          t(".vlt-content-slider").each(function () {
            var e = t(this),
              ...
              f = new Swiper(i, {
                ...
                freeMode: c,
                mousewheel: u,
                autoplay: !!o && { delay: h, disableOnInteraction: !1 },
                autoHeight: !0,
                slidesOffsetBefore: 100,
                slidesOffsetBefore:
                  !!d &&
                  t(".container").get(0).getBoundingClientRect().left + 15,
                slidesOffsetAfter:
                  !!d &&
                  t(".container").get(0).getBoundingClientRect().left + 15,
                navigation: {
                ...
                breakpoints: {
                  576: {
                    slidesPerView:
                      p.slides_to_show_mobile ||
                      p.slides_to_show_tablet ||
                      p.slides_to_show ||
                      1,
                    slidesPerGroup:
                      p.slides_to_scroll_mobile ||
                      p.slides_to_scroll_tablet ||
                      p.slides_to_scroll ||
                      1,
                  },
                  768: {
                    slidesPerView:
                      p.slides_to_show_tablet || p.slides_to_show || 1,
                    slidesPerGroup:
                      p.slides_to_scroll_tablet || p.slides_to_scroll || 1,
                  },
                  992: {
            ...
            f.on("init slideChange", function () {
              var i = t(n),
                ...
                r = (s + 1) / a;
              "vertical" == i.data("direction")
                ? (i.find(".current").text(VLTJS.addLedingZero(s + 1)),
                  i.find(".total").text(VLTJS.addLedingZero(a)))
                : (i.find(".current").text(s + 1), i.find(".total").text(a)),
                i
                  .find(".bar > span")
                  .css({ "--scaleX": r, "--speed": f.params.speed + "ms" });
            }),
              f.init();
          });
      },
  ...
  (function (t) {
    ...
    (VLTJS.countdown = {
      init: function (e) {
        void 0 !== t.fn.countdown &&
          t(".vlt-countdown").each(function () {
            var e = t(this),
              i = e.data("due-date") || !1;
      ...
      ((VLTJS.counterUp = {
        init: function () {
          ...
          e.each(function () {
            ...
            e.hasClass("vlt-counter-up--style-2") &&
              s.css({ "min-width": s.outerWidth() + "px" }),
        ...
        if (void 0 !== t.fn.justifiedGallery) {
          t(".vlt-justified-gallery").each(function () {
            ...
            e.imagesLoaded(function () {
              e.justifiedGallery({ rowHeight: i, margins: n, border: 0 });
            });
          });
        }
      },
          ...
          t(".vlt-progress-bar").each(function () {
            ...
            e.one("inview", function () {
              gsap.to(a, n / 1e3 / 2, {
                ...
                delay: s / 1e3,
                onUpdate: function () {
                  e.find(".vlt-progress-bar__title > .counter").text(
                    Math.round(a.count)
                  );
                },
              }),
        ...
        init: function () {
          ...
          if (e.length) {
            ...
            n.on("init slideChange", function () {
              ...
              e.on(
                "click",
                ".vlt-project-showcase__next-slide a",
                function (t) {
          ...
          if (e.length) {
            ...
            n.on("init slideChange", function () {
              switch (
                ...
                case "light":
                  t(".vlt-navbar").hasClass("vlt-navbar--white-text-on-top") &&
                    t(".vlt-navbar").removeClass(
                      "vlt-navbar--white-text-on-top"
                    ),
                    t(".vlt-site-fixed-bar").hasClass("has-white-color") &&
                      t(".vlt-site-fixed-bar").removeClass("has-white-color");
                  break;
                case "dark":
                  t(".vlt-navbar").hasClass("vlt-navbar--white-text-on-top") ||
                    t(".vlt-navbar").addClass("vlt-navbar--white-text-on-top"),
                    t(".vlt-site-fixed-bar").hasClass("has-white-color") ||
                      t(".vlt-site-fixed-bar").addClass("has-white-color");
              }
            }),
              n.on("init slideChange", function () {
                var s = t(i),
          ...
          function e() {
            i.find(".vlt-project-showcase__item").each(function () {
              var e = t(this),
                ...
                n = e
                  .find(".vlt-project-showcase__title.original")
                  .outerWidth(),
                s = e
                  .find(".vlt-project-showcase__title.original")
                  .offset().left,
              ...
              s.on("init slideChange", function () {
                var e = t(n),
                  ...
                  r = i
                    ...
                    .not(".swiper-slide-duplicate").length,
                  o = (a + 1) / r;
                "vertical" == e.data("direction")
                  ? (e.find(".current").text(VLTJS.addLedingZero(a + 1)),
                    e.find(".total").text(VLTJS.addLedingZero(r)))
                  : (e.find(".current").text(a + 1), e.find(".total").text(r)),
                  e
                    .find(".bar > span")
                    .css({ "--scaleX": o, "--speed": s.params.speed + "ms" });
              }),
              s.init();
          }
        },
              ...
              s.on("init slideChange", function () {
                var n = t(i),
                  ...
                  r = e
                    ...
                    .not(".swiper-slide-duplicate").length,
                  o = (a + 1) / r;
                "vertical" == n.data("direction")
                  ? (n.find(".current").text(VLTJS.addLedingZero(a + 1)),
                    n.find(".total").text(VLTJS.addLedingZero(r)))
                  : (n.find(".current").text(a + 1), n.find(".total").text(r)),
                  n
                    .find(".bar > span")
                    .css({ "--scaleX": o, "--speed": s.params.speed + "ms" });
              }),
